...
export default defineConfig({
  ...
  alias: { 
    '@rojer/form-render/es':  path.resolve(__dirname, 'packages/form-render/src'),
    '@rojer/form-render':  path.resolve(__dirname, 'packages/form-render/src'),
    '@rojer/table-render':  path.resolve(__dirname, 'packages/table-render/src'),
